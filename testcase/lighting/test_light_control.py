...
class TestLightControl:
    ...
    @mark_priority(0)
    @capture_failure
    def test_region_light_on(self, api_client, auth_context, lighting_resources):
        """
        区域全开灯测试
    ...
    @mark_priority(0)
    @capture_failure
    def test_region_light_off(self, api_client, auth_context, lighting_resources):
        """
        区域全关灯测试
    ...
    def test_temp_light(self, api_client, auth_context, lighting_resources, test_case):
        """
        临时灯开关测试（数据驱动）
